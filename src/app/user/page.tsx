        ...
        <div className="p-24">
          ...
          <div className="w-full flex items-center">
            ...
            <div className="w-full h-11 overflow-x-auto flex items-center gap-4">
              <button className="rounded-full pl-3 pr-3 bg-white text-black text-nowrap focus:bg-[#EF4444] focus:text-white">
                All dishes
              </button>
              {categories.map((category: CategoryType) => (
                <button
                  key={category.id}
                  className="rounded-full pl-3 pr-3 bg-white text-black text-nowrap focus:bg-[#EF4444] focus:text-white"
                >
                  {category.name}
                </button>
              ))}
