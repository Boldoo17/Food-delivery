    ...
    <div className="w-full">
      <div className="flex m-2">
        <img
          ...
          className="w-24 aspect-square rounded-2xl"
        />
      ...
      <div className="flex">
        ...
        <div>
          <div className="text-primary-foreground flex">
            Nom<div className="text-[#EF4444]">Nom</div>
          </div>
        ...
        <div className="flex gap-3">
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                className="w-80 rounded-full h-10 bg-white flex items-center justify-around p-4 text-muted-foreground"
              >
                <MapPin size={16} className="text-red-500" />
                <div className="text-red-500">Delivery address:</div>Add
                Location
                <ChevronRight size={16} />
              </Button>
            </PopoverTrigger>
            <PopoverContent className="w-80 rounded-3xl"></PopoverContent>
          </Popover>
          <Sheet>
            ...
            <SheetContent className="bg-primary rounded-s-2xl border-none text-primary-foreground">
              <SheetHeader className="m-4">
                <SheetTitle className="text-white flex gap-5">
                ...
                {orderVisible ? (
                  <div>
                    <div className="w-full bg-white p-2 rounded-full grid grid-cols-2">
                      <button
                        className="rounded-full pl-3 pr-3 text-nowrap bg-white text-black"
                        onClick={() => setOrderVisible(false)}
                      >
                        Cart
                      </button>
                      <button
                        className="rounded-full pl-3 pr-3 bg-[#EF4444] text-white"
                  ...
                  <div className="h-1/2 flex flex-col gap-6">
                    <div className="w-full bg-white p-2 rounded-full grid grid-cols-2">
                      <button
                        className="rounded-full pl-3 pr-3 text-nowrap bg-[#EF4444] text-white"
                        onClick={() => setOrderVisible(false)}
                      >
                        Cart
                      </button>
                      <button
                        className="rounded-full pl-3 pr-3 bg-white text-black text-nowrap "
                        onClick={() => setOrderVisible(true)}
                      >
                        Order
                      </button>
                    ...
                    <div className="w-full h-full rounded-3xl bg-white text-black p-3">
                      ...
                      <button className="w-full rounded-full border border-[#EF4444] mt-2 p-2 text-[#EF4444]">
                        Add Food
                      </button>
                    </div>
                  </div>
          ...
          <Button variant={"destructive"} className="rounded-full h-10 w-10">
            <UserRound />
          </Button>
        </div>
      ) : (
        <div className="flex gap-3">
          <Button className="bg-secondary font-medium text-secondary-foreground rounded-full">
            Sign up
          </Button>
          <Button className="bg-[#EF4444] font-medium rounded-full">
            Log in
          </Button>
        </div>
      )}
